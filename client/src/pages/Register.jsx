    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-slate-950 overflow-hidden relative">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-sm text-slate-400 mt-2 font-medium">Join the next-gen energy ecosystem</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="group relative">
            ...
            <p className="mt-2 text-[10px] text-slate-500 font-medium">Ensure your password is at least 8 characters long.</p>
          </div>
